...
class Model(metaclass=ModelMeta):
    ...
    def delete_column(cls, column_name: str) -> None:
        ...
        cls.orm_manager.raw.execute_query(query)

    @classmethod
    def delete_row(cls, **conditions) -> None:
        """
        ...
        cls.orm_manager.raw.execute_query(query, *values)
    ...
    def update_row(cls, values: Dict[str, Union[str, int, float]], condition: str) -> None:
        ...
        query = f"UPDATE {cls.get_table_name()} SET {set_clause} WHERE '{condition}'"

        parameter_values = list(values.values())
        cls.orm_manager.raw.execute_query(query, *parameter_values)

    @classmethod
    def select_one(cls, **conditions) -> Optional[Dict[str, Union[str, int, float]]]:
        """
        ...
        result = cls.orm_manager.fetch_all(query, *conditions.values())
