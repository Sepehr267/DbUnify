...
class Model(metaclass=ModelMeta):
    ...
    async def alter_table_schema(cls) -> None:
        ...
        for field_name, field in new_fields.items():
            if field_name not in existing_columns:
                await cls.orm_manager.add_column(table_name, field_name, field.data_type)
    ...
    @classmethod
    async def add_column(cls, column_name: str, data_type: str) -> None:
        """
        ...
        await cls.orm_manager.add_column(cls.get_table_name(), column_name, data_type)
    ...
    @classmethod
    async def delete_row(cls, condition_column: str, condition_value: str) -> None:
        """
        ...
        await cls.orm_manager.delete_row(cls.get_table_name(), condition_column, condition_value)
        
    @classmethod
    async def update_row(cls, values: Dict[str, Union[str, int, float]], condition_column: str, condition_value: str) -> None:
        """
        ...
        await cls.orm_manager.update_row(cls.get_table_name(), values, condition_column, condition_value)
