...
class Model(metaclass=ModelMeta):
    ...
    @classmethod
    def create_table_schema(cls) -> str:
        """
    ...
    @classmethod
    def alter_table_schema(cls) -> None:
        """
        ...
        existing_columns = cls.orm_manager.get_table_columns(table_name)
        new_fields = cls.get_fields()
        
        for field_name, field in new_fields.items():
            if field_name not in existing_columns:
                cls.orm_manager.add_column(table_name, field_name, field.data_type, field.constraints)
        ...
        for existing_column in existing_columns:
            if existing_column not in new_fields:
                cls.orm_manager.delete_column(table_name, existing_column)

    @classmethod
    def fetch_all(cls, query: str, *args) -> List[Tuple]:
        """
        ...
        return cls.orm_manager.fetch_all(query, *args)
    ...
    def create_table(cls) -> None:
        ...
        schema = cls.create_table_schema()
        cls.orm_manager.raw.execute_query(schema)
    ...
    def drop_table(cls) -> None:
        ...
        cls.orm_manager.drop_table(cls.get_table_name())

    @classmethod
    def add_column(cls, column_name: str, data_type: str, constraints: Optional[List[Union[str, Rules]]]) -> None:
        """
        ...
        cls.orm_manager.add_column(cls.get_table_name(), column_name, data_type, constraints_str)

    @classmethod
    def insert_row(cls, values: Dict[str, Union[str, int, float]]) -> None:
        """
        ...
        cls.orm_manager.insert_row(cls.get_table_name(), values)

    @classmethod
    def delete_column(cls, column_name: str) -> None:
        """
        ...
        cls.orm_manager.delete_column(cls.get_table_name(), column_name)

    @classmethod
    def delete_row(cls, condition: str, *args) -> None:
        """
        ...
        cls.orm_manager.raw.execute_query(query, *args)
        
    @classmethod
    def update_row(cls, values: Dict[str, Union[str, int, float]], condition: str) -> None:
        """
        ...
        cls.orm_manager.update_row(cls.get_table_name(), values, **{condition_key: condition_value})

    @classmethod
    def select_one(cls, condition: str, *args) -> Optional[Dict[str, Union[str, int, float]]]:
        """
        ...
        result = cls.orm_manager.fetch_all(query, *args)
        if result:
    ...
    @classmethod
    def select(cls) -> List[Dict[str, Union[str, int, float]]]:
        """
        ...
        results = cls.orm_manager.fetch_all(query)
        columns = cls.get_table_columns()
  
        return [dict(zip(columns.keys(), row)) for row in results]
  
    @classmethod
    def get_table_columns(cls) -> Dict[str, str]:
        """
        ...
        return cls.orm_manager.get_table_columns(cls.get_table_name())

    @classmethod
    def apply_migrations(cls) -> None:
        """
        ...
        table_name = cls.get_table_name()
        if not cls.orm_manager.table_exists(table_name):
            cls.create_table()
        ...
        for field_name, field_obj in model_fields.items():
            if field_name not in existing_columns:
                cls.orm_manager.add_column(table_name, field_obj.data_type, field_obj.constraints)
    ...
    def map_model(cls) -> None:
        ...
        for field_name, field_obj in cls._fields.items():
            if field_name not in existing_columns:
                cls.orm_manager.add_column(table_name, field_name, field_obj.data_type, field_obj.constraints)
